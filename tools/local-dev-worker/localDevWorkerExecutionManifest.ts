...
export const LOCAL_DEV_WORKER_EXECUTION_CAPABILITIES = [
  ...
  capability(
    ...
    [
      ...
      '--label',
      'lumixia.dremo.local-dev=true',
      '--label',
      'lumixia.dremo.kind=container-smoke',
      '--label',
      'lumixia.dremo.capability=capability.docker.container.smoke.echo',
      '--label',
      'lumixia.dremo.cleanup=review-required',
      '--network',
      'none',
      '--pull=never',
      '--read-only',
