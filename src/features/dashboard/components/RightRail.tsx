...
export const RightRail: React.FC = () => {
  ...
  return (
    <aside className="no-scrollbar flex h-full w-full flex-col gap-5 overflow-y-auto bg-white px-4 py-6 sm:px-5 sm:py-8 lg:px-6 lg:py-10">
      <section className="dashboard-glass-card relative overflow-hidden rounded-[26px] border border-amber-200/30 p-4 sm:rounded-3xl sm:p-5">
        <div className="absolute inset-0 bg-gradient-to-br from-amber-50/50 via-transparent to-primary/5" />
        <div className="relative z-10 min-w-0">
          <div className="mb-3 flex items-start justify-between gap-3 sm:items-center">
            <span className="material-symbols-outlined icon-filled shrink-0 text-[18px] text-[#A43C12] sm:text-lg">
              filter_vintage
            </span>
            <h4 className="min-w-0 text-right text-[10px] font-bold uppercase tracking-[0.22em] text-primary sm:text-[9px] sm:tracking-widest">
              Zen Moment
            </h4>
          </div>
          <p className="break-words font-serif text-[13px] italic leading-relaxed text-slate-600 sm:text-sm">
            "Clarity precedes success. Your financial aura is perfectly balanced
            today."
          </p>
        </div>
      </section>
      ...
      <section className="relative rounded-3xl">
        <div className="dashboard-glass-card dashboard-ambient-glow rounded-3xl border border-primary/10 p-5 blur-[4px] saturate-[0.78]">
        ...
        <ComingSoonVeil className="rounded-3xl" label="Coming soon" />
      </section>

      <section className="relative rounded-3xl">
        <div className="dashboard-glass-card dashboard-ambient-glow rounded-3xl border border-slate-100 p-5 blur-[4px] saturate-[0.78]">
